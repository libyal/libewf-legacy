...
#endif
{
	...
	/* TODO add tests for libewf_chunk_table_read_chunk */

	/* TODO add tests for libewf_chunk_table_read_offsets */

	/* TODO add tests for libewf_chunk_table_fill */

	/* TODO add tests for libewf_chunk_table_correct */

	/* TODO add tests for libewf_chunk_table_fill_offsets */
